...
- **Mobile tools:** Mobile tools can facilitate communication and collaboration, enabling distant and emergency communication, as well as e-learning. Mobile tools not only enable e-learning but also offer the opportunity for more personalized formats and can be the subject of e-learning. See also [Crowdsourcing Tools](../../general/cst.md).
