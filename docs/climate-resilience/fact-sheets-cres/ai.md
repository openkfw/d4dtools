...
**Machine learning (ML)** is a subclass of AI that focuses on the development of algorithms that enable computers to learn from and make decisions based on data. ML can be described by the training of models on data to recognize patterns and make corresponding predictions without the intervention of humans ([Brown 2021](https://mitsloan.mit.edu/ideas-made-to-matter/machine-learning-explained)).
