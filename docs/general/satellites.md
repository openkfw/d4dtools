...
- **Optical imagery (passive remote sensing technique):** Uses the
  ...
  requires further processing to derive _maps for vegetation types,
  crop vitality, or water quality, for example._
...
- **Radar** (Radio Detection and Ranging, **active remote sensing
  ...
  substituting or complementary. _Examples: detection of power
...
image processing towards the derivation of the thematic product will follow steps. _Examples of a few_ processing steps are: geometric-correction, selection of optimal band
...
- In the [Improving Energy Efficiency in Rural Areas in
  ...
  [Project (BMZ: 2009 66 663)](https://www.kfw-entwicklungsbank.de/PDF/Evaluierung/Ergebnisse-und-Publikationen/PDF-Dokumente-R-Z_EN/Vietnam_Energie_2020_E.pdf),
...
- In the city development project, [Innercity Bypass in
  ...
  [(BMZ: 2009 67 182)](https://www.kfw-entwicklungsbank.de/PDF/Evaluierung/Ergebnisse-und-Publikationen/PDF-Dokumente-R-Z_EN/Togo_Lom̩_2019_E.pdf),
